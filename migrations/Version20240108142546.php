 ...
 */
final class Version20240108142546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, cl_id INT NOT NULL, cl_nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, cl_adresse VARCHAR(255) NOT NULL, cl_code_postal INT NOT NULL, cl_ville VARCHAR(100) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
